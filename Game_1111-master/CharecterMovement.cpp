...
const int BG_MOVE_COEFFICIENT = 1;
    ...
    if(!jump){
        ...
        case 'r':
            ...
            if(characterPos.x < SCREEN_WIDTH/2 - characterPos.w){
                ...
                backgroundPos.w -= PIXELS_TO_MOVE_EACH_FRAME * BG_MOVE_COEFFICIENT + JUMP_MOVE_COEFFICIENT * .5; // reduce width otherwise tearing occurs
